    ...
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
        ...
        flex-col xl:px-0 sm:px-16 px-6`}>
            ...
            items-center w-full'>
                ...
                font-semibold ss:text-[72] text-[52px] text-white ss:leading-[100px]
                  leading-[75px]'>
            ...
            <h1 className='font-poppins 
                font-semibold ss:text-[768] text-[52px]
                text-white ss:leading-[100px]
                leading-[75px] w-full'>Payment Method.</h1>
                <p className={`${styles.paragraph}
                 max-w-[470px] mt-5`}>Our team of experts uses methodology to identify 
        ...
        md:my-0 my-10 relative`}>
          ...
          right-20 bottom-20 blue__gradient'></div>
        </div>
